// nvcc 3-6_Timer.cu DS_timer.cpp

/*
1. DS_timer timer(<num_of_timers>); -> Create DS_timer object
2. timer.setTimerName(<timer_id>, <timer_name>); -> Set timer name
3. timer.initTimers(); -> Initialize timers
4. timer.onTimer(<timer_id>); -> Start timer
5. timer.offTimer(<timer_id>); -> Stop timer
6. timer.printTimer(); -> Print all timer results
*/
